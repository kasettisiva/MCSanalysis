...
#ifndef protoDUNE_YZ_calib_h
#define protoDUNE_YZ_calib_h
...
#ifdef protoDUNE_YZ_calib_cxx
protoDUNE_YZ_calib::protoDUNE_YZ_calib(TTree *tree) : fChain(0) 
{
...
protoDUNE_YZ_calib::~protoDUNE_YZ_calib()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t protoDUNE_YZ_calib::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t protoDUNE_YZ_calib::LoadTree(Long64_t entry)
{
...
void protoDUNE_YZ_calib::Init(TTree *tree)
{
...
Bool_t protoDUNE_YZ_calib::Notify()
{
...
void protoDUNE_YZ_calib::Show(Long64_t entry)
{
...
Int_t protoDUNE_YZ_calib::Cut(Long64_t entry)
{
...
#endif // #ifdef protoDUNE_YZ_calib_cxx
