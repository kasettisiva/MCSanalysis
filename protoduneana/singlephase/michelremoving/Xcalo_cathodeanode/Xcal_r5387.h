...
#ifdef Xcal_r5387_cxx
Xcal_r5387::Xcal_r5387(TTree *tree) : fChain(0) 
{
...
Xcal_r5387::~Xcal_r5387()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Xcal_r5387::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Xcal_r5387::LoadTree(Long64_t entry)
{
...
void Xcal_r5387::Init(TTree *tree)
{
...
void Xcal_r5387::Show(Long64_t entry)
{
...
Int_t Xcal_r5387::Cut(Long64_t entry)
{
