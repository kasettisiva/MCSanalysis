...
TGraphErrors* GetSigmaFromGaussianGraph(TH2F* hist2D, const char* name, const char* title);
TGraph* GetSigmaRatioGraph(TGraph* rawSigmaGraph, TGraph* projectedSigmaGraph, const char* name, const char* title);
TGraph* GetSigmaDiffGraph(TGraph* rawSigmaGraph, TGraph* projectedSigmaGraph, const char* name, const char* title);
...
// TODO: Documentation
TGraph* GetSigmaDiffGraph(TGraph* sigma3D_GRAPH, TGraph* sigma2D_GRAPH, const char* name, const char* title) {
  // TODO: Assert that they're the correct relative length.
