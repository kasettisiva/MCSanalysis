...
#ifndef YZcalo_r5387_h
#define YZcalo_r5387_h
...
#ifdef YZcalo_r5387_cxx
YZcalo_r5387::YZcalo_r5387(TTree *tree) : fChain(0) 
{
...
YZcalo_r5387::~YZcalo_r5387()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t YZcalo_r5387::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t YZcalo_r5387::LoadTree(Long64_t entry)
{
...
void YZcalo_r5387::Init(TTree *tree)
{
...
void YZcalo_r5387::Show(Long64_t entry)
{
...
Int_t YZcalo_r5387::Cut(Long64_t entry)
{
