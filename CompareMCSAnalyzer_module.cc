...
public:
  ...
  Double_t otherfractionalDifference(Double_t trueMomentum, Double_t mcsMomentum);
...
private:
  ...
  TH1F* trueLinear_fracDiff_HIST;
  TH1F* truePolygonal_fracDiff_HIST;
  TH1F* trueLinear3D_fracDiff_HIST;
  TH1F* truePolygonal3D_fracDiff_HIST;

  TH1F* recoLinear_fracDiff_HIST;
  TH1F* recoPolygonal_fracDiff_HIST;
  TH1F* recoLinear3D_fracDiff_HIST;
  TH1F* recoPolygonal3D_fracDiff_HIST;
  ...
  TH2F* trueLinear_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* truePolygonal_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* trueLinear3D_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* truePolygonal3D_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* recoLinear_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* recoPolygonal_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* recoLinear3D_fracDiffVsTrueMomentum_Other_HIST;
  ...
  TH2F* recoPolygonal3D_fracDiffVsTrueMomentum_Other_HIST;
...
void CompareMCSAnalyzer::analyze(art::Event const & e) {
  ...
  */
  ...
  for(size_t iTrack = 0; iTrack < nTracks; iTrack++) {
    ...
    if(abs(particle.PdgCode()) == 13 && track->Length() >= 100) {
      ++numberOfMuonTracks;
      inMom = particle.P(0);
      lastMuonTrack = track;
    }
  ...
  if(trackIsWellReconstructed) {
    ...
    if(track->Length() >= 100) {
      ...
      std::cout << " recoLinear_MCSMomentum " << recoLinear_MCSMomentum
		<< " recoPolygonal_MCSMomentum " << recoPolygonal_MCSMomentum
		<< " recoLinear3D_MCSMomentum " << recoLinear3D_MCSMomentum 
                << " recoPolygonal3D_MCSMomentum " << recoPolygonal3D_MCSMomentum  
                << " trueLinear_MCSMomentum " << trueLinear_MCSMomentum  
                << " truePolygonal_MCSMomentum " << truePolygonal_MCSMomentum 
                << " trueLinear3D_MCSMomentum " << trueLinear3D_MCSMomentum  
                << " truePolygonal3D_MCSMomentum " << truePolygonal3D_MCSMomentum  
		<< std::endl; 
      ...
      recoLinear_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, recoLinear_MCSMomentum));

      recoLinear_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, recoLinear_MCSMomentum));
      ...
      recoPolygonal_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, recoPolygonal_MCSMomentum));

      recoPolygonal_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, recoPolygonal_MCSMomentum));
      ...
      recoLinear3D_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, recoLinear3D_MCSMomentum));

      recoLinear3D_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, recoLinear3D_MCSMomentum));
      ...
      recoPolygonal3D_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, recoPolygonal3D_MCSMomentum));

      recoPolygonal3D_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, recoPolygonal3D_MCSMomentum));
      ...
      trueLinear_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, trueLinear_MCSMomentum));

      trueLinear_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, trueLinear_MCSMomentum));
      ...
      truePolygonal_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, truePolygonal_MCSMomentum));

      truePolygonal_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, truePolygonal_MCSMomentum));
      ...
      trueLinear3D_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, trueLinear3D_MCSMomentum));

      trueLinear3D_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, trueLinear3D_MCSMomentum));
      ...
      truePolygonal3D_fracDiffVsTrueMomentum_Other_HIST->Fill(trueMomentum, otherfractionalDifference(trueMomentum, truePolygonal3D_MCSMomentum));

      truePolygonal3D_fracDiff_HIST->Fill(otherfractionalDifference(trueMomentum, truePolygonal3D_MCSMomentum));
...
void CompareMCSAnalyzer::beginJob() {
  ...
  trueLinear_fracDiff_HIST = tfs->make<TH1F>("trueLinear_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  recoLinear_fracDiff_HIST = tfs->make<TH1F>("recoLinear_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  trueLinear3D_fracDiff_HIST = tfs->make<TH1F>("trueLinear3D_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  recoLinear3D_fracDiff_HIST = tfs->make<TH1F>("recoLinear3D_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);

  truePolygonal_fracDiff_HIST = tfs->make<TH1F>("truePolygonal_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  recoPolygonal_fracDiff_HIST = tfs->make<TH1F>("recoPolygonal_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  truePolygonal3D_fracDiff_HIST = tfs->make<TH1F>("truePolygonal3D_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  recoPolygonal3D_fracDiff_HIST = tfs->make<TH1F>("recoPolygonal3D_fracDiff_HIST","(MCS Momentum-True Momentum)/True Momentum; (MCS Momentum-True Momentum)/True Momentum; Counts / bin",40,-2,2);
  ...
  trueLinear_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("trueLinear_fracDiffVsTrueMomentum_Other_HIST","True Linear Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference", 751, -0.05, 7.55, 50, -1.0, 1.0);
  ...
  truePolygonal_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("truePolygonal_fracDiffVsTrueMomentum_Other_HIST","True Poly Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference", 751, -0.05, 7.55, 50, -1.0, 1.0);
  ...
  trueLinear3D_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("trueLinear3D_fracDiffVsTrueMomentum_Other_HIST","True Linear 3D Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference (true trajectory)", 751, -0.05, 7.55, 50, -1.0, 1.0);
  trueLinear3D_fracDiffVsTrueMomentum_Other_HIST->SetStats(0);
  ...
  truePolygonal3D_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("truePolygonal3D_fracDiffVsTrueMomentum_Other_HIST","True Poly 3D Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference (true trajectory)", 751, -0.05, 7.55, 50, -1.0, 1.0);
  truePolygonal3D_fracDiffVsTrueMomentum_Other_HIST->SetStats(0);
  ...
  recoLinear_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("recoLinear_fracDiffVsTrueMomentum_Other_HIST","Reco Linear Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference", 751, -0.05, 7.55, 50, -1.0, 1.0);
  ...
  recoPolygonal_MCSMomentumVsTrueMomentum_HIST = tfs->make<TH2F>("recoPolygonal_MCSMomentumVsTrueMomentum_HIST","Reco Poly MCS Momentum vs True Momentum; True Momentum (GeV/c); Reco Poly MCS Momentum (GeV/c)",9, 0.0, 4.5, 9, 0.0, 4.5);
  ...
  recoPolygonal_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("recoPolygonal_fracDiffVsTrueMomentum_Other_HIST","Reco Poly Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference", 751, -0.05, 7.55, 50, -1.0, 1.0);
  ...
  recoLinear3D_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("recoLinear3D_fracDiffVsTrueMomentum_Other_HIST","Reco Linear 3D Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference (true trajectory)", 751, -0.05, 7.55, 50, -1.0, 1.0);
  recoLinear3D_fracDiffVsTrueMomentum_Other_HIST->SetStats(0);
  ...
  recoPolygonal3D_fracDiffVsTrueMomentum_Other_HIST = tfs->make<TH2F>("recoPolygonal3D_fracDiffVsTrueMomentum_Other_HIST","Reco Poly 3D Fractional Difference vs. True Momentum; True Momentum (GeV/c); Fractional Difference (true trajectory)", 751, -0.05, 7.55, 50, -1.0, 1.0);
  recoPolygonal3D_fracDiffVsTrueMomentum_Other_HIST->SetStats(0);
...
Double_t CompareMCSAnalyzer::otherfractionalDifference(Double_t trueMomentum, Double_t mcsMomentum) {
  return (mcsMomentum - trueMomentum) * (1/trueMomentum);
}
